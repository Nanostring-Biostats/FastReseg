...
prepSMI_for_fastReseg <- function(path_to_SMIobject, 
  ...
  #smi_inputs <- prepSMI_for_fastReseg(
    path_to_SMIobject = path_to_SMIobject  
    config_loading = config_loading
    refClus_coln = "cell_type"
  ...
  #cell_metadata <- copy(gem@cell_metadata$rna)
  ...
  #exprs_tgrt <- gem@expression$rna$raw
